...
///
/// <b>Authored ids only.</b> This is a load-time check on what a person types — sheet and lore
/// filenames, and the keys in <c>seed.json</c>. Whether ids <i>proposed by extraction</i>
/// should be held to the same shape is a separate question with a different cost (a rejection
/// cascade, not a refused load) and belongs with the validator.
/// </summary>
