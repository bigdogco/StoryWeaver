...
- When starting on a new task (usually a new chat), create a `docs/todo/TODO_{TASK}_.md` document
- If there are any structural changes to the project, update the `TODO_{TASK}_.md` document
